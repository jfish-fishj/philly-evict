...
cfg <- read_config()
log_file <- p_out(cfg, "logs", "merge-altos-parcels.log")

logf("=== Starting merge-altos-parcels.R ===", log_file = log_file)
...
logf("=== Finished merge-altos-parcels.R ===", log_file = log_file)
