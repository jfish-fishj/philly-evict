...
However, many of the most important parts of a landlord-tenant relationship are \textbf{bargained} over
      ...
      \end{itemize}
      \pause
Role of evictions in disciplining tenants has implications for landlord tenant policy, even though most evictions are for nonpayment of rent
\end{frame}
...
\begin{itemize}
    \item Low income landlords generally have \textbf{higher} profit margins \parencite{Desmond_2019,Damen_2025}
     \begin{itemize}
        \item this is largely explained by lower costs
      \end{itemize}
...
\begin{frame}{A brief attempt at a dynamic problem}
