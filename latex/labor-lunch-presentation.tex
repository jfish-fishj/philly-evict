...
\begin{frame}{Model Setup}
    ...
    \item Common discount factor \boldsymbol{$0 < \beta < 1$}
...
\begin{frame}{Matching}
    \begin{itemize}
    \item For each rental vacancy, landlords pay a per period cost of \boldsymbol{$c_i$}
    ...
    \item Home finding rate = \boldsymbol{$\lambda \equiv \frac{v}{u}(1-e^{-\frac{v}{u}})$}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item \boldsymbol{$f_i$} indicates landlord size (market share)
    \item \begin{equation}
