...
\begin{frame}{Recap of Stylized Facts}
    ...
    \tiny
    \input{tables/hedonic_filing_rate_cuts}
...
\begin{frame}{High Evicting Landlords Increased Prices Post-COVID}
    ...
    \tiny
    \input{tables/covid_price_change_regs}
...
\begin{frame}{Frame Title}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{figs/mean_p}
        \caption{Caption}
...
\begin{frame}{New Ideas}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{c|c}
             ...
             & 
        \end{tabular}
        \input{tables/rental_stock_over_time}
        %\caption{Caption}
